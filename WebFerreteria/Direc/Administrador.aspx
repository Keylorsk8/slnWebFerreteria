    ...
    <form runat="server">
        ...
        <section id="Content">
            ...
            <div class="tabsContainer">
                ...
                <div class="tabPanel table-responsive"><!--PANEL 1-->
                    <asp:GridView runat="server" ID="gridClientes" CssClass="table" DataKeyNames="Id" CellPadding="4" GridLines="Horizontal"
                        ...
                        OnRowDataBound="gridClientes_RowDataBound" BackColor="White" BorderColor="#336666" BorderStyle="Ridge" BorderWidth="3px">
                        <Columns>
                ...
                <div class="tabPanel"><!--PANEL 2-->
                    <div id="AgregarProducto">
                        ...
                        <div class="InputProducto4">
                            <h4>Imágen</h4>
                            <asp:FileUpload ID="fluImagen" CssClass="form-control" runat="server" required/>
                        </div>
                        ...
                        <div class="InputProducto6">
                             <asp:Button ID="btnAgregarProducto" CssClass="btn btn-success" runat="server" Text="Agregar" OnClick="btnAgregarProducto_Click"/>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <asp:GridView runat="server" ID="gridProductos" CssClass="table" DataKeyNames="ID" CellPadding="4" GridLines="Horizontal"
                            AllowPaging="True" PageSize="5" OnRowEditing="gridProductos_RowEditing" OnRowUpdating="gridProductos_RowUpdating"
                            OnRowCancelingEdit="gridProductos_RowCancelingEdit" OnRowDeleting="gridProductos_RowDeleting"
                            OnRowDataBound="gridProductos_RowDataBound" BackColor="White" BorderColor="#336666" BorderStyle="None" BorderWidth="3px">
                            <Columns>
                                <asp:CommandField ShowEditButton="True" />
                                <asp:CommandField ShowDeleteButton="True" />
                            </Columns>
