<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MantProductos.aspx.cs" Inherits="WebFerreteria.MantProductos" %>
    ...
    <div class="carousel slide" data-ride="carousel">
       ...
       <div class="row">
        ...
        <div style=" margin-left:100px" width: 200px ; height: 200px;>
            <div>
            <asp:FileUpload ID="fileUpload" runat="server" Width="196px" />

            <div style="height:200px;width:200px;background-color:green;">
            <asp:Image ID="imagen" runat="server" style="width:200px"/>

        </div>

       <%-- <asp:Button ID="btnSubirImagen" runat="server" Text="Subir Imagen" OnClick="btnSubirImagen_Click" Width="197px" />--%>

        <br />
                
    </div>
            
            <asp:Button ID="Button1" runat="server" Text="Mostra" Width="200px" OnClick="MostrarIMG" />
           ...
           <div class="col-lg-4" > 
                    <fieldset>
                        <legend>Nuevo Tornuillo</legend>
                        
                        <div class="form-group">
                            <label for="nombre">Nombre</label>
                            <input class="form-control" id="txtnombre" placeholder="Nombre" type="text" runat="server" required="required" />
                        </div>
                        <div class="form-group">
                            <label for="descrip">Descripcion</label>
                            <input class="form-control" id="txtDescripcion" type="text" runat="server" required="required" />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="txtPrecio" type="number" runat="server" required="required" min="1" max="10000" placeholder="##" />
                        </div>
